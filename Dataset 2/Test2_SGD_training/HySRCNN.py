...
if __name__ == '__main__':
    ...
    test_image = read_tfrecord(test_file, img_size)
    test_batch = tf.train.shuffle_batch([test_image],
                batch_size = batch_size,
                capacity = 1000 + 3 * batch_size,
                num_threads = 2,
                min_after_dequeue = 1000)
    ...
    with tf.Session() as sess:
        ...
        test_HR, test_LR, test_LR_pad = build_img_pair(sess.run(test_batch),img_size)
